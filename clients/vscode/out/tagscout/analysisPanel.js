...
class AnalysisPanel {
    ...
    static createOrShow(extensionUri, results) {
        ...
        const panel = vscode.window.createWebviewPanel('tagscoutResults', 'TagScout Analysis Results', column, {
            enableScripts: true,
...
<body>
    ...
    _generateClientInfoHtml(results) {
