...
export class ConsoleWebview {
    ...
    public static createOrShow(extensionUri: vscode.Uri): ConsoleWebview {
    ...
    private _navigateToLine(file: string, line: number): void {
        if (!file) return;
    ...
    private _filterMessages(severity: string | null): void {
